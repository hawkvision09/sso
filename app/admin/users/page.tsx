  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 min-h-screen">
        {/* Header */}
        <div className="px-12 py-8 bg-white/5 backdrop-blur-2xl border-b border-white/10">
          <button
            onClick={() => router.push("/admin")}
            className="mb-4 px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white font-semibold hover:bg-white/15 transition-all"
          >
            ← Back to Admin
          </button>
